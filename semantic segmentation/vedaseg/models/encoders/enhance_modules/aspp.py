...
class ASPP_v2(nn.Module):
    def __init__(self, in_channels, out_channels, atrous_rates, from_layer,
        ...
        modules.append(
            nn.Conv2d(in_channels, out_channels, 3, 1, padding=rate1, dilation=rate1, bias=True))
        modules.append(
            nn.Conv2d(in_channels, out_channels, 3, 1, padding=rate2, dilation=rate2, bias=True))
        modules.append(
            nn.Conv2d(in_channels, out_channels, 3, 1, padding=rate3, dilation=rate3, bias=True))
        modules.append(
            nn.Conv2d(in_channels, out_channels, 3, 1, padding=rate4, dilation=rate4, bias=True))
