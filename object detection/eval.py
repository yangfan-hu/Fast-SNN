...
parser.add_argument('--init', type=str, default='weights/', 
...
parser.add_argument('--cuda', action='store_true', default=False,
                    help='Use cuda')
# dataset
parser.add_argument('--root', default='/home/huyangfan/',
                    help='data root')
...
if __name__ == '__main__':
    ...
    net.load_state_dict(torch.load(args.init, map_location='cuda'))
    net.eval()
