...
from backbone.darknet_tiny_v2 import build_darknet_tiny_v2
import tools

class YOLOv2tiny(nn.Module):
    def __init__(self, device, input_size=None, num_classes=20, trainable=False, conf_thresh=0.001, nms_thresh=0.5, anchor_size=None, bit=32, spike=False):
        ...
        self.backbone = build_darknet_tiny_v2(bit=bit, spike=spike, num_anchors=self.num_anchors, num_classes=self.num_classes)
